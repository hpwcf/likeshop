...
<script lang="ts" setup name="decorationUserPages">
...
> = reactive({
    [pagesTypeEnum.HOME]: {
        ...
        pageData: generatePageData(['search', 'banner', 'nav', 'title-bar', 'goods-group', 'rubik'])
    },
    [pagesTypeEnum.USER]: {
        id: 2,
        type: 2,
        name: '个人中心',
        pageMeta: generatePageData(['page-meta']),
        pageData: generatePageData(['user-info', 'user-order', 'user-service', 'user-banner'])
    }
})
