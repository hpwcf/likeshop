<template>
    <el-form ref="form" label-width="80px" size="large" class="flex flex-col min-h-0 flex-1 h-full">
        <el-card shadow="never" class="!border-none flex flex-1 mt-2" body-class="flex-1">
            ...
            <el-form-item v-if="content.title_type == 2">
                <material-picker v-model="contentData.title_img" exclude-domain :limit="1" size="100px" />
            ...
            <el-form-item v-if="content.bg_type == 2">
                <material-picker v-model="contentData.bg_image" exclude-domain :limit="1" size="100px" />
