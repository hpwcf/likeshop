    ...
    <attritube-tabs title="图片魔方">
        <template #content>
            <el-form label-width="70px" label-position="left" class="flex flex-col min-h-0 h-full">
                ...
                <el-card
                    shadow="never"
                    class="flex-1 !border-none flex mt-2"
                    body-class="flex-1 rounded-t-lg"
                >
                    <div class="flex items-end">
                    ...
                    <div class="flex-1 mt-4">
                        <div style="background: #f9f9f9" class="flex items-center p-6 rounded-xl">
                            ...
                            <div class="flex-1">
                                <LinkPickerStaff class="flex-1" v-model="currentData.link" />
                            </div>
                        </div>
                    </div>
                </el-card>
        ...
        <template #styles>
            <el-form label-width="70px" label-position="left" class="flex flex-col min-h-0 h-full">
                ...
                <el-card
                    shadow="never"
                    class="flex-1 !border-none flex mt-2 !rounded-b-lg"
                    body-class="flex-1"
                >
                    <div class="flex items-end">
