                                        ...
                                        <div class="flex justify-center w-[467px]">
                                            <template v-if="content.style == 1">
                                                ...
                                                >
                                                    <template #upload>
                                                        <div
                                                            class="w-[122px] h-[122px] banner-upload-btn"
                                                        >
                                                            轮播图
                                                        </div>
                                                    </template>
                                                ...
                                                <material-picker
                                                    v-if="
                                                        content.style == 1 || content.bg_style == 1
                                                    "
                                                    class="ml-[40px]"
                                                    size="122px"
                                                    v-model="item.bg"
                    ...
                    <div class="flex-1">
                        <el-form-item label="3D效果">
                            <el-radio-group v-model="styles.effect3d">
                                <el-radio :label="0" size="large" border>关闭</el-radio>
                                <el-radio :label="1" size="large" border>开启</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="指示器样式">
                            <el-radio-group v-model="styles.mode">
                                <el-radio label="round" size="large" border>圆角</el-radio>
                                <el-radio label="rect" size="large" border>圆形</el-radio>
                                <el-radio label="number" size="large" border>数字</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="指示器位置">
                            <el-radio-group v-model="styles.indicator_pos">
                                <el-radio label="bottomLeft" size="large" border>左侧</el-radio>
                                <el-radio label="bottomCenter" size="large" border>居中</el-radio>
                                <el-radio label="bottomRight" size="large" border>右侧</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </div>
                </el-card>
